...
exports.doCharge = function(req, res, next) {
  ...
  var chargeToken = 'Basic ' + new Buffer('SB-Mid-server-bGXv9v8pby5S8pXpCuEeIpbI').toString('base64'); // Dummy Charge Token
...
exports.doChargeProd = function(req, res, next) {
  ...
  var chargeToken = 'Basic ' + new Buffer('SB-Mid-server-bGXv9v8pby5S8pXpCuEeIpbI').toString('base64');
